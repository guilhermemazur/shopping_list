...
class ShoppingListsControllerTest < ActionController::TestCase
  ...
  test "should create shopping_list" do
    assert_difference('ShoppingList.count') do
      post :create, shopping_list: { date: @shopping_list.date, is_purchased: @shopping_list.is_purchased, product_id: @shopping_list.product_id, user_id: @shopping_list.user_id }
    end
  ...
  test "should update shopping_list" do
    patch :update, id: @shopping_list, shopping_list: { date: @shopping_list.date, is_purchased: @shopping_list.is_purchased, product_id: @shopping_list.product_id, user_id: @shopping_list.user_id }
    assert_redirected_to shopping_list_path(assigns(:shopping_list))
  end
